...
foreignRedirectMap = [
  ...
  , ("C:chmod, libc 6, sys/stat.h", "rapid_system_file_chmod")
  ...
  , ("C:idris2_readBufferData, libidris2_support, idris_buffer.h", "idris_rts_read_buffer_data")
  , ("C:idris2_writeBufferData, libidris2_support, idris_buffer.h", "idris_rts_write_buffer_data")
